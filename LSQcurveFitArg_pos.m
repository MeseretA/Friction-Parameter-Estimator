function [problem, Function_PDexpr, Function_PDexpr_full] = LSQcurveFitArg_pos(Xdata, Ydata,F_c, F_s,X0,key)
...
OPTIONS_LSQCURVEFIT.StepTolerance = 1e-55;
% OPTIONS_LSQCURVEFIT.FunctionTolerance  = 1e-23;
OPTIONS_LSQCURVEFIT.FunctionTolerance  = 1e-55;
...
% problem.x0 = [X0.Fc_p, X0.Fs_p, X0.vs_p, X0.Fv1_p, X0.Fv2_p, X0.Fv3_p];
% problem.x0 = [X0.Fv1_p, X0.Fv2_p, X0.Fv3_p, X0.Fv4_p, X0.Fv5_p, X0.Fv6_p,X0.Fc_p];
problem.x0 = [X0.Fv1_p, X0.Fv2_p, X0.Fv3_p];
% problem.x0 = [X0.Fv1_n, X0.Fv2_n, X0.Fv3_n, X0.Fv4_n, X0.Fv5_n, X0.Fv6_n, -12.4];
% problem.x0 = [X0.vs_p, X0.Fv1_p, X0.Fv2_p, X0.Fv3_p];
problem.xdata = Xdata;
problem.ydata = Ydata;
