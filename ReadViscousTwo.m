function Indy7FrictionData201905130954 = ReadViscousTwo(filename, startRow, endRow)
%IMPORTFILE 텍스트 파일의 숫자형 데이터를 행렬로 가져옵니다.
%   INDY7FRICTIONDATA201905130954 = IMPORTFILE(FILENAME) 디폴트 선택 항목의 텍스트 파일
%   FILENAME에서 데이터를 읽습니다.
%
%   INDY7FRICTIONDATA201905130954 = IMPORTFILE(FILENAME, STARTROW, ENDROW)
%   텍스트 파일 FILENAME의 STARTROW 행에서 ENDROW 행까지 데이터를 읽습니다.
%
% Example:
%   Indy7FrictionData201905130954 = importfile('Indy7FrictionData_201905130954.csv', 4, 102);
%
%    TEXTSCAN도 참조하십시오.

% MATLAB에서 다음 날짜에 자동 생성됨: 2019/05/13 16:02:56
...
%% 출력 변수 만들기
Indy7FrictionData201905130954 = [dataArray{1:end-1}];
