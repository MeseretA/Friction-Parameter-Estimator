function Indy7FrictionData201905150856 = ReadViscousData515(filename, startRow, endRow)
%IMPORTFILE 텍스트 파일의 숫자형 데이터를 행렬로 가져옵니다.
%   INDY7FRICTIONDATA201905150856 = IMPORTFILE(FILENAME) 디폴트 선택 항목의 텍스트 파일
%   FILENAME에서 데이터를 읽습니다.
%
%   INDY7FRICTIONDATA201905150856 = IMPORTFILE(FILENAME, STARTROW, ENDROW)
%   텍스트 파일 FILENAME의 STARTROW 행에서 ENDROW 행까지 데이터를 읽습니다.
%
% Example:
%   Indy7FrictionData201905150856 = importfile('Indy7FrictionData_201905150856.csv', 4, 40);
%
%    TEXTSCAN도 참조하십시오.

% MATLAB에서 다음 날짜에 자동 생성됨: 2019/05/15 11:28:15
...
%% 출력 변수 만들기
Indy7FrictionData201905150856 = [dataArray{1:end-1}];
