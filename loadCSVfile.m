function Indy7FrictionDatajoint1 = loadCSVfile(filename, startRow, endRow)
...
%
% Example:
%   Indy7FrictionDatajoint1 = importfile('Indy7FrictionData_joint1.csv', 4, 73);
%
%    TEXTSCAN도 참조하십시오.

% MATLAB에서 다음 날짜에 자동 생성됨: 2019/05/06 22:16:18
